...
def process_location(file):
    ...
    invalid_df = df.filter(col("reason").isNotNull()).select("id", "name", "country", "country_code", "reason")
...
if "Contents" in response:
    for obj in response["Contents"]:
        ...
        if key.endswith(".json"):
            ...
            if key.startswith("shopify/failed/locations"):
                entity = "location"
